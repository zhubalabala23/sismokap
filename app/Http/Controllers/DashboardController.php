...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $cachedData = Cache::remember("dashboard_data_{$selectedYear}", 300, function () use ($selectedYear) {
        ...
        return view('dashboard', array_merge($cachedData, compact('selectedYear', 'years')));
    }
}
