...
<div class="card p-4 bg-white">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3 border-bottom pb-3 mb-4">
        <form action="{{ route('laporan.bulanan') }}" method="GET" class="row g-2 align-items-end m-0 w-100" style="max-width: 600px;">
    ...
    <div class="text-center mb-4 d-none d-print-block">
        <h3 class="fw-bold">LAPORAN PROGRESS BULANAN PROYEK</h3>
        <p class="text-muted">Bulan: {{ $namaBulan[$bulan] }} {{ $tahun }}</p>
    </div>
        ...
        <table class="table table-bordered table-hover align-middle">
            <thead class="table-light">
                <tr class="text-muted fs-7">
                    ...
                    <th scope="col" style="width: 150px;">PROGRESS (AGGREGATE)</th>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="9" class="text-center text-muted py-4 fs-7">Tidak ada data progress proyek pada bulan ini.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
